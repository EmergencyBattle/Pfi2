...
public class DigitalClockGUI extends JFrame {
	...
	public DigitalClockGUI() {
		...
		lblAlarmClock.setFont(new Font("Gadugi", Font.BOLD, 32));
		...
		imageClock.setIcon(new ImageIcon(DigitalClockGUI.class.getResource("/Images/clockicon.png")));
	...
	public void alarm (boolean activate){
		if (true) {
			lblAlarmMsg.setText("RINGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGG");
		}
